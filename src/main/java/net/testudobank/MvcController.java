...
public class MvcController {
   ...
   * 
   * @param model
   * @return "autotransfer_form" page
   */
  @GetMapping("/autotransfer")
  public String showAutoTransferForm(Model model) {
    User user = new User();
    model.addAttribute("user", user);
  ...
  private static Date stringToDate(String dateString) {
    ...
    try {
      ...
      date = SQL_DATETIME_FORMATTER.parse(dateString);
      if (!dateString.equals(SQL_DATETIME_FORMATTER.format(date))) {
        date = null;
      }
  ...
  public String submitAutoTransfer(@ModelAttribute("user") User sender) {
